...
class M_internet extends CI_Model
{
    public function view_by_date($date)
    {
        ...
        return $this->db->get('tbl_internet')->result(); // Tampilkan data transaksi sesuai tanggal yang diinput oleh user pada filter
    }
    ...
    public function view_by_month($month, $year)
    {
        ...
        return $this->db->get('tbl_internet')->result(); // Tampilkan data transaksi sesuai bulan dan tahun yang diinput oleh user pada filter
    }
    ...
    public function view_by_year($year)
    {
        ...
        return $this->db->get('tbl_internet')->result(); // Tampilkan data transaksi sesuai tahun yang diinput oleh user pada filter
    }

    public function view_all()
    {
        return $this->db->get('tbl_internet')->result(); // Tampilkan semua data transaksi
    }
